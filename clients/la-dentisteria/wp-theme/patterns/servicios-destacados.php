...
<section class="wp-block-group servicios-section has-beige-background-color has-background" style="padding-top:90px;padding-right:36px;padding-bottom:90px;padding-left:36px">
  ...
  <!-- wp:heading {"level":2} -->
  <h2>Tres especialidades<br><em>que transforman sonrisas.</em></h2>
  <!-- /wp:heading -->
  ...
  <div class="wp-block-columns">
    ...
    <div class="wp-block-column servicio-card has-background" style="border-color:var(--wp--preset--color--line);border-width:1px;border-radius:8px;background-color:#ffffff;padding:28px 24px">
      ...
      <p class="servicio-more has-teal-color has-text-color"><a href="/servicios/ortodoncia-medellin/">Conocer más →</a></p>
      <!-- /wp:paragraph -->
    </div>
    <!-- /wp:column -->
    ...
    <div class="wp-block-column servicio-card has-background" style="border-color:var(--wp--preset--color--line);border-width:1px;border-radius:8px;background-color:#ffffff;padding:28px 24px">
      <!-- wp:paragraph {"className":"servicio-num","style":{"typography":{"fontFamily":"var(--wp--preset--font-family--serif)","fontSize":"36px","fontStyle":"italic","lineHeight":"1"}},"textColor":"teal"} -->
      <p class="servicio-num has-teal-color has-text-color" style="font-size:36px;font-style:italic;line-height:1;font-family:var(--wp--preset--font-family--serif)">02</p>
      <!-- /wp:paragraph -->
      <!-- wp:heading {"level":3,"style":{"typography":{"fontSize":"24px"}}} -->
      <h3 style="font-size:24px">Diseño de Sonrisa</h3>
      <!-- /wp:heading -->
      <!-- wp:paragraph {"style":{"typography":{"fontSize":"13px","lineHeight":"1.55"},"color":{"text":"var:preset|color|ink-soft"}}} -->
      <p style="font-size:13px;line-height:1.55">Carillas, blanqueamiento y resinas estéticas. Resultados naturales pensados para adultos.</p>
      <!-- /wp:paragraph -->
      <!-- wp:paragraph {"className":"servicio-more","style":{"typography":{"fontSize":"11px","textTransform":"uppercase","letterSpacing":"0.1em","fontWeight":"600"}},"textColor":"teal"} -->
    ...
    <div class="wp-block-column servicio-card has-background" style="border-color:var(--wp--preset--color--line);border-width:1px;border-radius:8px;background-color:#ffffff;padding:28px 24px">
      <!-- wp:paragraph {"className":"servicio-num","style":{"typography":{"fontFamily":"var(--wp--preset--font-family--serif)","fontSize":"36px","fontStyle":"italic","lineHeight":"1"}},"textColor":"teal"} -->
      <p class="servicio-num has-teal-color has-text-color" style="font-size:36px;font-style:italic;line-height:1;font-family:var(--wp--preset--font-family--serif)">03</p>
      <!-- /wp:paragraph -->
      <!-- wp:heading {"level":3,"style":{"typography":{"fontSize":"24px"}}} -->
      <h3 style="font-size:24px">Cirugía Maxilofacial</h3>
      <!-- /wp:heading -->
      <!-- wp:paragraph {"style":{"typography":{"fontSize":"13px","lineHeight":"1.55"},"color":{"text":"var:preset|color|ink-soft"}}} -->
      <p style="font-size:13px;line-height:1.55">Cordales, implantes dentales y cirugía ortognática con técnicas avanzadas y máxima precisión.</p>
      <!-- /wp:paragraph -->
      <!-- wp:paragraph {"className":"servicio-more","style":{"typography":{"fontSize":"11px","textTransform":"uppercase","letterSpacing":"0.1em","fontWeight":"600"}},"textColor":"teal"} -->
